...
class NewslettersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create newsletter" do
    assert_difference('Newsletter.count') do
      post newsletters_url, params: { newsletter: { delivered_at: @newsletter.delivered_at, subject: @newsletter.subject } }
    end
  ...
  test "should update newsletter" do
    patch newsletter_url(@newsletter), params: { newsletter: { delivered_at: @newsletter.delivered_at, subject: @newsletter.subject } }
